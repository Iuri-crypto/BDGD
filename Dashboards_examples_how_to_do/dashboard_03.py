...
current_power = np.array([currents[0], currents[1]])
power = np.array([potencies[0], potencies[1]])
                ...
                figure={
                    'data': [
                        go.Scatter(
                            ...
                            text=[f'{current:.2f}, {p:.2f}' for current, p in zip(current_power[0], power[0])],
                            name='Corrente vs Potência Barramento 1'
                        ),
                        go.Scatter(
                            x=current_power[1],
                            y=power[1],
                            ...
                            text=[f'{current:.2f}, {p:.2f}' for current, p in zip(current_power[1], power[1])],
                            name='Corrente vs Potência Barramento 2'
                        )
                    ],
                    'layout': go.Layout(
        ...
        dcc.Graph(
            ...
            figure={
                'data': [
                    ...
                    go.Scatter(
                        x=np.concatenate([nodes[edge[0], 0], nodes[edge[1], 0], None]),
                        y=np.concatenate([nodes[edge[0], 1], nodes[edge[1], 1], None]),
                        mode='lines',
