...
class DataBaseQuery:
    ...
    def consulta_banco(self, offset=0, limit=1000):
        ...
        try:
            query = f"""
                SELECT
                    ucmt_tab.tip_cc, 
                    ucmt_tab.pac, ucmt_tab.ctmt, ucmt_tab.fas_con, ucmt_tab.ten_forn, ucmt_tab.cod_id
                FROM 
                    ucmt_tab
                WHERE ucmt_tab.gru_ten = 'MT' 
